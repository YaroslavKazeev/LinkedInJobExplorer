                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 mb-3">
                          We're looking for an experienced engineer to join our
                          team and help build scalable solutions...
                        </p>
            ...
            <div className="flex-1">
              ...
              <div className="border-2 border-gray-300 rounded p-6 mb-4">
                ...
                <div className="text-sm text-gray-700 space-y-3">
                  <p>
                    We are seeking a talented Senior Software Engineer to join
                    our dynamic team...
                  </p>
              ...
              <div className="border-2 border-gray-300 rounded p-6">
                ...
                <p className="text-sm text-gray-700 mb-3">
                  Tech Company Inc. is a leading innovator in cloud-based
                  solutions, serving millions of users worldwide...
                </p>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    <span className="text-gray-600">Specialties:</span> Cloud,
                    AI, SaaS
                  </div>
                </div>
              </div>
